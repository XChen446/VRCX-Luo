    ...
    <div class="flex flex-col gap-10 py-2">
        ...
        <SettingsGroup :title="t('view.settings.appearance.display.header')">
            ...
            <SettingsItem
                ...
                <Switch
                    :model-value="useOfficialStatusColors"
                    :ariaLabel="t('view.settings.appearance.appearance.use_official_status_colors')"
                    @update:modelValue="toggleOfficialStatusColors" />
            </SettingsItem>
        </SettingsGroup>
